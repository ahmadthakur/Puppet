...
module.exports = {
  ...
  async execute(interaction) {
    ...
    const file = new AttachmentBuilder("./assets/dice/diceroll.gif");
    ...
    const dicenumber = new AttachmentBuilder(`./assets/dice/dice${dice}.png`);

    setTimeout(() => {
      embed.setDescription(`You rolled a ${dice}`)
